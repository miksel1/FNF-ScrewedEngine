...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<Dynamic>> = [ //Name - Icon name - Description - Link - BG Color
			[{s: 'Screwed Engine Team', spanish: 'Equipo Screwed Engine'}],
			...
			[{s: 'MemeHoovy'},				'meme',				{s: 'Additional Programmer and Deleting-Coder', spanish: 'Programador y Reparador de Errores.\n(Además de Eliminar código innecesario)'},							'https://twitter.com/meme_hoovy',		'438434'],
			[{s: 'Delta'},				    'delta',			{s: 'Strident Engine'},												'https://www.youtube.com/c/Delta1248',									'0xFF00C6FF'],
			[{s: 'miksel'},					'miksel',			{s: 'Features and Ideas', spanish: 'Ideas y Extras'},									        'https://www.youtube.com/@miksel_fnf',	                                '371893'],
			...
			['tposejank',			'jank',				{s: 'Spanish Alphabet Support', spanish: 'Ayuda Abecedario Español'},										'https://twitter.com/tpose_jank',		'B9AF27'],
			...
			['Codename Engine',		'name',				{s: 'Songs with EXTRA length', spanish: 'Extra Duración de las Canciones'},										'https://github.com/YoshiCrafter29/CodenameEngine',	'0xFF25748D'],
			['Impostorm Team',		'amogus',			{s: 'Shaders and Ideas', spanish: 'Shaders e Ideas'},											'https://vsimpostor.com/',				'0x590000'],
			['chromasen', 			'',					{s: 'VS DAVE WINDOWS/LINUX/MACOS UTIL\n65% of the code', spanish: 'Util VS DAVE\n65% del código'},			'',										'0x0026FF'],
			['Erizur',				'',					'VS DAVE WINDOWS/LINUX/MACOS UTIL\n35% of the code.\n(cross-platform and extra windows utils)',		'',	'0x00FF33'],
			[''],
