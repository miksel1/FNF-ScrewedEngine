...
class FunkinLua {
	...
	public function new(script:String) {
		...
		// shader shit
		lua.add_callback("initLuaShader", function(name:String) {
		...
		lua.add_callback("getRunningScripts", function(){
			return [for (idx in 0...PlayState.instance.luaArray.length) PlayState.instance.luaArray[idx].scriptName];
		});
		...
		// some shit
		lua.add_callback("getDeviceName", function() {
			return Lib.application.window.application.window.application.window.display.name; // lol
		});
		lua.add_callback("getBorderless", function() {
			return Lib.application.window.borderless;
		});
		lua.add_callback("setBorderless", function(v:Bool) {
			return Lib.application.window.borderless = v;
		});
		lua.add_callback("getFullscreen", function() {
			return Lib.application.window.fullscreen;
		});
		lua.add_callback("setFullscreen", function(v:Bool) {
			return Lib.application.window.fullscreen = v;
		});
		lua.add_callback("getHeight", function() {
			return Lib.application.window.height;
		});
		lua.add_callback("setHeight", function(newHeight:Int) {
			return Lib.application.window.height = newHeight;
		});
		lua.add_callback("getHidden", function() {
			return Lib.application.window.hidden;
		});
		lua.add_callback("getWindowID", function() {
			return Lib.application.window.id;
		});
		lua.add_callback("getMaximized", function() {
			return Lib.application.window.maximized;
		});
		lua.add_callback("setMaximized", function(v:Bool) {
			return Lib.application.window.maximized = v;
		});
		lua.add_callback("getMinimized", function() {
			return Lib.application.window.minimized;
		});
		lua.add_callback("setMinimized", function(v:Bool) {
			return Lib.application.window.minimized = v;
		});
		lua.add_callback("getMouseLock", function() {
			return Lib.application.window.mouseLock;
		});
		lua.add_callback("setMouseLock", function(v:Bool) {
			return Lib.application.window.mouseLock = v;
		});
		lua.add_callback("getWidth", function() {
			return Lib.application.window.width;
		});
		lua.add_callback("setWidth", function(newWidth:Int) {
			return Lib.application.window.width = newWidth;
		});
		lua.add_callback("getWindowTitle", function() {
			return Lib.application.window.title;
		});
		lua.add_callback("setWindowTitle", function(newTitle:String) {
			return Lib.application.window.title = newTitle;
		});
		lua.add_callback("getWindowX", function() {
			return Lib.application.window.x;
		});
		lua.add_callback("setWindowX", function(x:Int) {
			return Lib.application.window.x = x;
		});
		lua.add_callback("getWindowY", function() {
			return Lib.application.window.y;
		});
		lua.add_callback("setWindowY", function(y:Int) {
			return Lib.application.window.y = y;
		});
		lua.add_callback("getResizable", function() {
			return Lib.application.window.resizable;
		});
		lua.add_callback("getWindowScale", function() {
			return Lib.application.window.scale;
		});
		lua.add_callback("getWindowTextInputEnabled", function() {
			return Lib.application.window.textInputEnabled;
		});
		lua.add_callback("setWindowTextInputEnabled", function(v:Bool) {
			return Lib.application.window.textInputEnabled = v;
		});
		lua.add_callback("getFrameRate", function() {
			return Lib.application.window.frameRate;
		});
		lua.add_callback("setFrameRate", function(framerate:Float) {
			return Lib.application.window.frameRate = framerate;
		});
		lua.add_callback("closeWindow", function() {
			Lib.application.window.close();
		});
		lua.add_callback("resizeWindow", function(width:Int, height:Int) {
			Lib.application.window.resize(width, height);
		});
		lua.add_callback("warpMouse", function(x:Int, y:Int) {
		...
		lua.add_callback("addGlitchEffect", function(tag:String, ?waveAmplitude:Float = 0.1, ?waveFrequency:Float = 5, ?waveSpeed:Float = 2.25)
		{
			if(PlayState.instance.modchartSprites.exists(tag)) {
				var stuff:ModchartSprite = PlayState.instance.modchartSprites.get(tag);
		...
		lua.add_callback("addWiggleEffect", function(tag:String, ?type:String = 'FLAG', ?waveAmplitude:Float = 0.1, ?waveFrequency:Float = 5, ?waveSpeed:Float = 2.25,
		...
		lua.add_callback("add3DWorldEffect", function(tag:String) {
			if(PlayState.instance.modchartSprites.exists(tag)) {
				var stuff:ModchartSprite = PlayState.instance.modchartSprites.get(tag);
				stuff.shader = PlayState.the3DWorldEffect.shader;
				return true;
		...
		lua.add_callback("add" + /*'New' + */ "MosaicEffect", function(tag:String, strengthX:Float, strengthY:Float) {
			if(PlayState.instance.modchartSprites.exists(tag)) {
				var stuff:ModchartSprite = PlayState.instance.modchartSprites.get(tag);
		...
		lua.add_callback("windowTweenY", function(tag:String, value:Dynamic, duration:Float, ease:String) {
	...
	//haxe is shit.
	public static function getSTATICFlxEaseByString(?ease:String = '') {
		switch(ease.toLowerCase().trim()) {
			case 'backin': return FlxEase.backIn;
			case 'backinout': return FlxEase.backInOut;
			case 'backout': return FlxEase.backOut;
